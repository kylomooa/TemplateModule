...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/POBaseModule/POBaseModule.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/POBaseUIModule/POBaseUIModule.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/POLocaltionTool/POLocaltionTool.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/POMediaTool/POMediaTool.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PONetWorking/PONetWorking.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/POPhotoPickerModule/POPhotoPickerModule.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/POPreviewImageView/POPreviewImageView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/POQiniuTool/POQiniuTool.framework"
